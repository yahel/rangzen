...
/**
 * @author Sean Owen This class creates a Runnable that can start and stop
 *         scanning for a result. It also uses a multiformat reader in order to
 *         read many types of barcodes. This code is found in an imported jar
 *         file related to Zxing.
 * @author jesus Changed this file somewhat in order to be able to accept a
 *         fragment rather than activity for its constructor.
 */
    ...
    private final class DecodeHandler extends Handler {
        ...
        DecodeHandler() {
            ...
            hints.put(DecodeHintType.POSSIBLE_FORMATS, Arrays.asList(
                    BarcodeFormat.AZTEC, BarcodeFormat.QR_CODE,
        ...
        private void decode(byte[] data) {
            ...
            PlanarYUVLuminanceSource source = new PlanarYUVLuminanceSource(
                    data, width, height, excessWidth / 2, excessHeight / 2,
                    subtendedWidth, subtendedHeight, false);
            ...
            if (rawResult == null) {
                ...
                message = handler.obtainMessage(R.id.decode_succeeded,
                        rawResult);
            }
