...
<div class="box clearfix meta">
        ...
        <div class="foundat">
            Defined in: <a href="../files/lib_arango.js.html#l77"><code>lib&#x2F;arango.js:77</code></a>
        </div>
...
<div class="box intro">
    <p>Creates an arango connection, can be called either with a JSON Object representing the connection or with a
connection String.</p>
...
<div class="yui3-g">
    <div class="yui3-u-1-2">
            ...
            <ul class="module-classes">
                ...
                <li class="module-class">
                    <a href="../classes/admin.html">
                        admin
                    </a>
                </li>
            
                <li class="module-class">
                    <a href="../classes/aqlfunction.html">
                        aqlfunction
                    </a>
                </li>
            
                <li class="module-class">
                    <a href="../classes/arango.html">
                        arango
                    </a>
                </li>
            
                <li class="module-class">
                    <a href="../classes/batch.html">
                        batch
                    </a>
                </li>
                ...
                <li class="module-class">
                    <a href="../classes/cursor.html">
                        cursor
                    </a>
                </li>
            
                <li class="module-class">
                    <a href="../classes/database.html">
                        database
                    </a>
                </li>
                ...
                <li class="module-class">
                    <a href="../classes/edge.html">
                        edge
                    </a>
                </li>
            
                <li class="module-class">
                    <a href="../classes/endpoint.html">
                        endpoint
                    </a>
                </li>
                ...
                <li class="module-class">
                    <a href="../classes/jobs.html">
                        jobs
                    </a>
                </li>
            
                <li class="module-class">
                    <a href="../classes/query.html">
                        query
                    </a>
                </li>
            
                <li class="module-class">
                    <a href="../classes/simple.html">
                        simple
                    </a>
                </li>
            
                <li class="module-class">
                    <a href="../classes/transaction.html">
                        transaction
                    </a>
                </li>
            
                <li class="module-class">
                    <a href="../classes/traversal.html">
                        traversal
                    </a>
                </li>
            
                <li class="module-class">
                    <a href="../classes/users.html">
                        users
                    </a>
                </li>
    ...
    <div class="yui3-u-1-2">
            ...
            <ul class="module-submodules">
                ...
                <li class="module-submodule">
                    <a href="../modules/aqlfunction.html">
                        aqlfunction
                    </a>
...
every request. Calling "Exec" switches back to normal mode and executes the batch.
                ...
                <li class="module-submodule">
                    <a href="../modules/collection.html">
                        collection
                    </a>
...
This module wraps the cursor module.
                ...
                <li class="module-submodule">
                    <a href="../modules/transaction.html">
                        transaction
                    </a>
